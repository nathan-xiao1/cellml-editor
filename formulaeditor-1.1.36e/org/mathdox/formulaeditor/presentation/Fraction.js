  ...
  org.mathdox.formulaeditor.presentation.Fraction =
    $extend(org.mathdox.formulaeditor.presentation.Node, {
      ...
      draw : function(canvas, context, x, y, invisible) {
        ...
        var margin = 4.0; /* total margin */
        var lineXMargin = margin * 0.5 ; /* part of width-margin for line */
        var lineWidth = 1.0;
	  ...
	  2 * margin + lineWidth;
        ...
        if (!invisible) {
          ...
          canvasContext.moveTo(x + lineXMargin, y);
          canvasContext.lineTo(x + width - lineXMargin, y);
