...
$require("org/mathdox/formulaeditor/modules/linalg1/outerproduct.js");
$require("org/mathdox/formulaeditor/modules/linalg1/scalarproduct.js");
...
$require("org/mathdox/formulaeditor/modules/logic4/common_knowledge.js");
$require("org/mathdox/formulaeditor/modules/logic4/necessarily.js");
$require("org/mathdox/formulaeditor/modules/logic4/possibly.js");
...
$require("org/mathdox/formulaeditor/modules/units/ExpressionWithUnit.js");
...
$require("org/mathdox/formulaeditor/presentation/RowInputSpace.js");
  ...
  org.mathdox.formulaeditor.FormulaEditor = $extend(Object, {
    ...
    initialize : function(textarea, canvas) {
      ...
      if (textarea) {
        ...
        var position = this.presentation.getFirstBoxCursorPosition();

        if (position == null) {
          position = this.presentation.getFollowingCursorPosition();
        }

        this.cursor = new Cursor(position);
        this.draw();
