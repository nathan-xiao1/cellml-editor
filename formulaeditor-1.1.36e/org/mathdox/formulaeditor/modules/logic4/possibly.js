...
$identify("org/mathdox/formulaeditor/modules/logic4/possibly.js");
...
$main(function(){
  ...
  var symbol =  {
    onscreen : ["⋄","",""],
    openmath : "<OMS cd='logic4' name='possibly'/>",
    mathml   : ["<mo>⋄</mo>","",""]
  };
      
  var symbol_sub =  {
    onscreen : symbol.onscreen,
    openmath : "<OMS cd='logic4' name='modal_unary_operator'/>",
   ...
   */
  org.mathdox.formulaeditor.semantics.Logic4Possibly =
   ...
   */
  org.mathdox.formulaeditor.semantics.Logic4Modal_unary_operator =
    $extend(org.mathdox.formulaeditor.semantics.MultaryOperation, {
  ...
  org.mathdox.formulaeditor.parsing.openmath.OpenMathParser =
    $extend(org.mathdox.formulaeditor.parsing.openmath.OpenMathParser, {
      ...
      */
      handleLogic4Possibly : function(node) {

        var operand = this.handle(node.childNodes.item(1));
        return new org.mathdox.formulaeditor.semantics.Logic4Possibly(operand);
      ...
      * Returns a unary object based on the OpenMath node.
      */
      handleLogic4Modal_unary_operator : function(node) {

        var operand = this.handle(node.childNodes.item(1));
        var result = new org.mathdox.formulaeditor.semantics.Logic4Modal_unary_operator(operand);
  ...
  org.mathdox.formulaeditor.parsing.expression.ExpressionContextParser.addFunction( 
    function(context) { return {
      ...
      // expression140 = logic4possibly | logic4modal_unary_operator | super.expression140
      expression140 : function() {
        var parent = arguments.callee.parent;
        pG.alternation(
          pG.rule("logic4possibly"),
          pG.rule("logic4modal_unary_operator"),
          parent.expression140).apply(this, arguments);
      },

      // logic4possibly = "⋄" expression140 
      logic4possibly :
        pG.transform(
          pG.concatenation(
            pG.literal('⋄'),
          ...
          function(result) {
            return new semantics.Logic4Possibly(result[1]);
          }
        ),

      // logic4possiblyalt = "⋄" (subscript | func_sub_indexexpr) expression140 
      logic4modal_unary_operator :
        pG.transform(
          pG.concatenation(
            pG.literal('⋄'),
            pG.alternation(
          ...
          function(result) {
            var oper=new semantics.Logic4Modal_unary_operator(result[1]);
