...
$main(function(){
  ...
  org.mathdox.formulaeditor.semantics.Cycle =
    $extend(org.mathdox.formulaeditor.semantics.MultaryListOperation, {
      ...
      bracketedRuleArgs : "permutationBracesWithArguments",
  ...
  org.mathdox.formulaeditor.parsing.expression.ExpressionContextParser.addFunction( 
    function(context) { return {
        ...
        permutationBraces : 
          pG.transform(
            pG.repetitionplus(
              pG.rule("permutationBracesWithArguments")
            ),
            function(result) {
              var cycles = [];
              var entries;
        ...
        permutationBracesWithArguments: pG.never
        }
      });
});
