...
$main(function(){
  ...
  org.mathdox.formulaeditor.presentation.Row =
	...
	var modifiedContext = { rowLevel : 0 };
        ...
        // allow for local context overrides
        if (this.drawContext !== undefined && this.drawContext !== null) {
          for (name in this.drawContext) {
            modifiedContext[name] = this.drawContext[name];
          }
        }

        // default row modification(s)
