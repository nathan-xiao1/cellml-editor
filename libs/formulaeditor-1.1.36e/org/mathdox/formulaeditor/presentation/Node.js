...
$main(function(){
  ...
  org.mathdox.formulaeditor.presentation.Node = $extend(Object, {
    ...
    */
    ...
    /* get cursor position in first box */
    getFirstBoxCursorPosition : function() {
      ...
      while (i < this.children.length && cursor == null) {
        cursor = this.children[i].getFirstBoxCursorPosition();

        if (cursor == null && this.children[i] instanceof org.mathdox.formulaeditor.presentation.BlockSymbol) {
          return {row: this, index: i };
        }
